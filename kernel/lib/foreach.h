...
#ifndef foreach_count
#define foreach_count(name, array, count)   for (int (__##array##_##indexer__) = 0, (__##array##_##run_once__) = 1; ( __ ## array ## _ ## indexer__) < (count) && (__##array##_##run_once__); ++(__ ## array ## _ ## indexer__), (__##array##_##run_once__) = !(__##array##_##run_once__)) \
                                            for (typeof(array[0]) name = array[(__##array##_##indexer__)]; (__##array##_##run_once__); (__##array##_##run_once__) = !(__##array##_##run_once__))
#endif 
