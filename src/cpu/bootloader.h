...
/* Stolen from https://github.com/stivale/stivale2-barebones/blob/master/kernel/kernel.c */
...
static struct stivale2_header stivale_hdr = {
    ...
    // downwards.
    .stack = (pointer_t)stack + sizeof(stack),
    ...
    .tags = (pointer_t)&framebuffer_hdr_tag
};
